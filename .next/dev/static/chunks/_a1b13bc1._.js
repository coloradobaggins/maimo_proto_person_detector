...
(()=>{
    const e = new Error("Cannot find module '@/hooks/useFaceApi'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module '@/hooks/useWebcam'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module '@/hooks/useFaceDetection'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
;
...
function Home() {
    ...
    const { detectionState, canvasRef } = useFaceDetection(videoRef, isReady, isLoaded, isDebug);
